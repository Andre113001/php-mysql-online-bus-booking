    ...
    <div class="container-fluid container-sm d-flex align-items-center justify-content-between brand">
        ...
        <nav id="navbar" class="navbar">
            <div class="lc-block d-grid gap-2 d-md-flex justify-content-md-start">
                ...
                <a href="landing-login.php" class="mx-5">Login</a>
            </div>
        </nav> 
        <!-- END nav -->
    </div>
            ...
            <div class="card" style="border-radius: 1rem;">
              <div class="row g-0">
                <div class="col-md-6 col-lg-5 d-none d-md-block">
                  <img src="https://images.pexels.com/photos/7658238/pexels-photo-7658238.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                ...
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <div class="row mb-3">
                      <div class="col-2">
                        <img src="../assets/img/icon-email.png" class="w-100" alt="">
                      </div>
                      <div class="col d-flex align-items-center">
                        <span class="desc">irosin.elavil@gmail.com</span>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <div class="col-2">
                        <img src="../assets/img/icon-phone.png" class="w-100" alt="">
                      </div>
                      <div class="col d-flex align-items-center">
                        <span class="desc">+63 935 039 4703</span>
                      </div>
                    </div>

                    <div class="row mb-3">
                      <div class="col-2">
                        <img src="../assets/img/icon-address.png" class="w-100" alt="">
                      </div>
                      <div class="col d-flex align-items-center">
                        <span class="desc">Headquarters: 309 P. Tuazon Blvd, Project 4, Quezon City, 1109 Metro Manila, Philippines</span>
                      </div>
                    </div>
